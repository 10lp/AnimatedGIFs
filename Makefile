...
flash:
	...
	esptool.py --chip esp32 --port /dev/ttyUSB0 --baud 921600 write_flash  0x110000 img.ffat || esptool.py --chip esp32 --port /dev/ttyUSB0 --baud 460800 write_flash  0x110000 img.ffat
